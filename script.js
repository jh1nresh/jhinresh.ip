...
if (hlsVideo) {
  ...
  if (source && HlsConstructor?.isSupported()) {
  ...
  } else if (source && hlsVideo.canPlayType("application/vnd.apple.mpegurl")) {
    hlsVideo.src = source;
...
window.addEventListener("pagehide", () => hlsInstance?.destroy(), { once: true });
